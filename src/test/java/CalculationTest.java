...
public class CalculationTest {
    ...
    double[] testArray8 = {1, 3, 2, 5, 8, 7, 12, 2, 4};

    double[] testArray9 = {8, 6, 9, 4, 3, 3, 2, 7, 7};
    ...
    public void testCoviance() {
        double result = BasicCalculation.calcCovariance(testArray8, testArray9);
        assertThat(result, is(-7.1729));
        result = BasicCalculation.calcCovariance(testArray5, testArray6);
        assertThat(result, is(4.6667));
    }
